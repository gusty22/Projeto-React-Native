...
export const style = StyleSheet.create({
    ...
    button: { backgroundColor: themes.colors.primary, height: themes.metrics.inputHeight, borderRadius: themes.metrics.borderRadius, justifyContent: 'center', alignItems: 'center', marginTop: 20, elevation: 3 },
